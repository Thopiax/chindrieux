...
export const dict = {
  ...
  'today.leads': { en: '{name} leads', fr: '{name} est en tête', pt: '{name} está na frente', nl: '{name} staat bovenaan' },
  'today.proposeNudge': { en: 'Propose a moment for the Oscars!', fr: 'Propose un moment pour les Oscars !', pt: 'Proponha um momento pro Oscar!', nl: 'Stel een moment voor voor de Oscars!' },
